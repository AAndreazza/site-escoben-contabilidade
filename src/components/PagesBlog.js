    ...
    return (
        <div>
            ...
            <div className="bg-white font-montserrat">
                <div className="mx-auto max-w-7xl mb-20 grid grid-cols-1 gap-x-8 gap-y-0 sm:gap-y-16 sm:grid-cols-2 lg:grid-cols-3">
                    {data.posts.edges.map(post => (
                        <div className='bg-slate-100 rounded-2xl drop-shadow-xl mt-10 sm:mt-20 mx-8 sm:mx-0' key={post.node.slug}>
