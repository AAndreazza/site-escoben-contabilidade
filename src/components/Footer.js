...
const Footer = () => {
    return (
        <footer className='bg-[#402347] font-montserrat'>
                            ...
                            <li>
                                <div className='flex gap-x-2'>
                                    <dt className='flex-none'>
                                        ...
                                        <Link to={getWhatsUrl(CTA_WHATSAPP_MENSAGENS.ctaButton)}>
                                            <svg
                                                xmlns='http://www.w3.org/2000/svg'
                                                className='h-6 w-5 sm:h-7 sm:w-6 text-gray-200'
                                                fill='currentColor'
                            ...
                            <ul className='flex'>
                                ...
                                <li className='mr-6'>
                                    <Link to={URLS.facebook}>
                                        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 50 50' className='h-7 w-7 text-gray-200'
                                            fill='currentColor'>
