        ...
        <div>
            ...
            <div className="flex flex-col md:flex-row">
                ...
                <div class="isolate px-6 mb-20 lg:px-20 font-montserrat">
                    ...
                    <form action="https://formsubmit.co/alanaandreazza26@gmail.com" method="POST" class="mx-auto max-w-xl rounded-3xl p-8 ring-2 ring-[#793486] shadow-2xl">
                        <input type="text" name="nome" id="nome" autocomplete="given-name" placeholder="Nome completo" class="mt-2.5 block w-full rounded-md border-0 px-3.5 py-2 sm:py-3 sm:mt-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
