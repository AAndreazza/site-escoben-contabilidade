...
const Formulario = () => {
    return (
        ...
        <div className='isolate px-6 -mt-10 mb-20 lg:px-8 font-montserrat'>
            ...
            <form action='https://formsubmit.co/alanaandreazza26@gmail.com' method='POST' className='mx-auto mt-16 max-w-xl sm:mt-20 rounded-3xl p-8 ring-2 ring-[#4b253c] bg-[#4b253c] shadow-2xl'>
                ...
                <div className='mt-10 sm:mt-10 mb-5 text-center'>
                    <button
                        type='submit'
                        className='rounded-full bg-[#d6c5d3] drop-shadow-2xl px-8 py-4 sm:px-20 sm:py-4 font-semibold text-xl text-[#31182c] shadow-sm hover:bg-[#ebe1e8] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#b1ffe9]'
                    >
                        Enviar mensagem
                    </button>
                </div>
