            ...
            <div className='bg-white py-20'>
                <div className='mx-auto grid max-w-6xl grid-cols-1 lg:grid-cols-12'>
                    ...
                    <div className='col-span-11 lg:col-span-6'>
                        <p className='sm:ml-0 ml-12 mr-4 text-xl sm:text-2xl font-montserrat leading-6 text-black'>Nosso propósito é transformar a sua empresa em um negócio de sucesso. Soluções completas para a sua gestão contábil, fiscal e trabalhista.</p>
                    </div>
                </div>
            </div>
