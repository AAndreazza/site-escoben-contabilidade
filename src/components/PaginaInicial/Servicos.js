...
const Servicos = () => {
    return (
        <div className='bg-white py-8 sm:py-24 font-montserrat'>
            <div className='mx-auto max-w-7xl px-6 lg:px-8'>
                <div className='mx-auto text-center px-0'>
                    <h2 className='text-5xl sm:text-7xl font-bold text-[#e4d5e7]'>SERVIÇOS</h2>
                    ...
                    <div className='mx-auto max-w-2xl lg:max-w-5xl'>
                        <dl className='grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16'>
                            <div className='flex items-center'>
                                ...
                                <div>
                                    <dt className='text-xl sm:text-2xl font-bold leading-7 text-[#793486]'>Contabilidade</dt>
                            ...
                            <div className='flex items-center'>
                                ...
                                <div>
                                    <dt className='text-xl sm:text-2xl font-bold leading-7 text-[#793486]'>Gestão Fiscal</dt>
                            ...
                            <div className='flex items-center'>
                                ...
                                <div>
                                    <dt className='text-xl sm:text-2xl font-bold leading-7 text-[#793486]'>Gestão Trabalhista e Previdenciária</dt>
                            ...
                            <div className='flex items-center'>
                                ...
                                <div>
                                    <dt className='text-xl sm:text-2xl font-bold leading-7 text-[#793486]'>Gestão Societária e Outros Serviços</dt>
                            ...
                            <div className='flex items-center'>
                                ...
                                <div>
                                    <dt className='text-xl sm:text-2xl font-bold leading-7 text-[#793486]'>Controle dos Investimentos na Bolsa de Valores</dt>
                            ...
                            <div className='flex items-center'>
                                ...
                                <div>
                                    <dt className='text-xl sm:text-2xl font-bold leading-7 text-[#793486]'>Imposto de Renda da Pessoa Física</dt>
                            ...
                            <div className='flex items-center'>
                                ...
                                <div>
                                    <dt className='text-xl sm:text-2xl font-bold leading-7 text-[#793486]'>Consultoria & Treinamentos</dt>
