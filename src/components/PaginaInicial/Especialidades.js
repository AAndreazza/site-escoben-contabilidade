...
const Especialidades = () => {
    return (
        <div className='bg-white mt-0 sm:mt-80 py-24 sm:py-24 font-montserrat'>
            <div className='mx-auto max-w-7xl sm:mt-60'>
                <div className='mx-auto text-center'>
                    <h2 className='text-4xl sm:text-6xl font-bold text-[#e4d5e7]'>ESPECIALIDADES</h2>
                    ...
                    <p className='text-base text-gray-900 sm:text-2xl'>Uma <b>contabilidade</b> que conhece o seu negócio</p>
                </div>
