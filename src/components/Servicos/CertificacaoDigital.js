...
import Servico from '../../images/certificacaoDigital.webp'

const CertificacaoDigital = () => {
    return (
            ...
            <div className='max-w-7xl mx-auto px-8 sm:px-40'>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-y-6 lg:gap-8 items-center justify-center'>
                    ...
                    <div className='mx-auto lg:mx-0 lg:max-w-xl'>
                        <h1 className='sm:mt-10 text-3xl font-bold text-[#4b253c] sm:text-4xl text-left' id='certificacao-digital'>CERTIFICAÇÃO DIGITAL </h1>
                        <ul className='mt-6 space-y-4 text-lg leading-6 text-gray-600'>
                            <li className='flex gap-x-1'>
                                ...
                                Compra, emissão, renovação e suporte de Certificados Digitais e-CPF e e-CNPJ.
                            </li>
                        </ul>
                        <div className='mt-10 text-center lg:text-left'>
                            <Link
                                to={getWhatsUrl(CTA_WHATSAPP_MENSAGENS.ctaCertificacao)}
                                target='_blank'
