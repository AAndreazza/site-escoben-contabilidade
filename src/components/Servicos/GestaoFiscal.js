...
const GestaoFiscal = () => {
    return (
        <div className="font-montserrat mt-20 sm:mt-10">
            <div className="max-w-7xl ml-0 sm:ml-20 px-8 sm:px-40">
                ...
                <img src={Servico}
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl lg:col-span-2 xl:col-auto">GESTAO FISCAL</h1>
