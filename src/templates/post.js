        ...
        <div className='font-montserrat bg-gray-100'>
            ...
            <div class="px-6 mt-12 mb-12 sm:mt-16 sm:mb-16 lg:px-8">
                <div class="mx-auto max-w-4xl text-base leading-7 text-gray-900">
                    <p class="text-xl font-semibold text-center leading-7 text-[#673272]">{data.contentfulPost.categoria}</p>
            ...
            <div class="text-center mb-20">
                <Link
                    to='../../servicos'
                    className='rounded-full bg-[#4b253c] drop-shadow-2xl px-6 py-4 sm:px-8 sm:py-4 mb-8 text-base sm:text-xl font-semibold text-white shadow-sm hover:bg-[#5f374f] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#b1ffe9]'
                >
